"""Create reproducible paired V1/V2 comparison statistics."""
...
if __name__ == "__main__":
    ...
    output_directory = project_root / "results" / "effectiveness_v2"
    ...
    destination = output_directory / "comparison_v1_v2.json"
