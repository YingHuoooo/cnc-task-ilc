"""Run the isolated V11 online delay-compensation development screen."""
...
from cnc_task_ilc.delay_compensation_benchmark import (
    ...
    run_delay_compensation_development,
)


if __name__ == "__main__":
    root = Path(__file__).resolve().parents[1]
    payload = run_delay_compensation_development(
        root / "data" / "tolerance_conflict_v1" / "task_manifests.json",
        root / "results" / "development_v11_delay_compensation",
        BenchmarkSettings(
